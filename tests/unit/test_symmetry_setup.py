...
# NOTE: the (x,x,z) and (0,y,y) coupling patterns are currently uncovered -- LTA (zeolite A,
# Pm-3m) carried them and was removed with its unused anchor fixture. See the test-fixture
# variety issue.
