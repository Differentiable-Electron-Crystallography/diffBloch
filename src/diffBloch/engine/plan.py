...
class OrientationPlan:
    ...
    def build(
        ...
        *,
        ...
        curve: :class:`~diffBloch.core.products.PlainSum` sums them and
        :class:`~diffBloch.core.products.MosaicAverage` applies normalized PETS-derived weights.
...
class CoupledOrientationPlan:
    ...
    required: PETS-derived mosaic weights apply across the complete expanded tilt geometry.
