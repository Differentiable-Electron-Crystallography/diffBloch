...
| `scattering_factors` | `"lobato2026"` | Electron scattering-factor table. `"lobato2026"` (Lobato, Zhang, Van Aert & Kirkland, 2026): element-adaptive Dirac-Pade basis (2-15 terms per element, fitted against updated relativistic Dirac-Fock densities), most accurate for heavier elements. `"lobato2014"` ([Lobato & Van Dyck, 2014](publications-and-references.md)): the original fixed 5-term basis. |
