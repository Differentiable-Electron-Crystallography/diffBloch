...
snapshots, and locks go under `reproducibility/`. Text or HTML summaries are views generated by
report tooling over the JSONL report, not extra refinement side effects.
